      ...
      {isSignIn && (
        <>
          <button
            ...
            className="w-full bg-red-500 hover:bg-red-600 text-white text-sm mt-2 p-3 rounded flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full bg-gray-900 hover:bg-black text-white text-sm mt-2 p-3 rounded flex items-center justify-center gap-2"
          >
